...
prosadila celá řada oborových **de-facto** standardů, t.j. standardy prosazené tržní
...
Open GIS konzorcium bylo založeno v roce 1994 devěti členy. V roce
2015 má jeho nástupce OGC nad 500 členů - komerčních firem,
veřejných institucí, univerzit i jednotlivců. Dnes OGC poskytuje více jako 
35 implementačních standardů, které jsou **volně dostupné** a adresují různé 
výzvy ve vztahu k prostorovým datům.
Další organizace, například :ref:`ISO <iso>`, v České republice působící 
:ref:`ČSN <csn>` a podobně, se také
